...
| **Quality** | 230 backend tests incl. real WebSocket tests · GitHub Actions CI (Postgres, deploy checks, Android build, Docker) |
...
```bash
cd backend && python manage.py test        # 230 tests, including real WebSocket tests
