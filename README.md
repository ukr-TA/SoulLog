...
| **Quality** | 234 backend tests incl. real WebSocket tests · GitHub Actions CI (Postgres, deploy checks, Android build, Docker) |
...
```bash
cd backend && python manage.py test        # 234 tests, including real WebSocket tests
